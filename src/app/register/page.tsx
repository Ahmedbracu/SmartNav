...
import { Navigation, Lock, Mail, User, Eye, EyeOff } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center page-transition">
      <div className="glass-card w-full max-w-md p-8 relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
          <div className="space-y-1">
            ...
            <div className="relative">
              <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#5F6368] pointer-events-none" />
              <input 
                type="text" 
                name="name"
                placeholder="John Doe" 
                required
                className="w-full bg-white/60 border border-[#DADCE0]/60 rounded-lg py-3 pl-11 pr-4 text-[#202124] placeholder-[#8b949e]/50 focus:outline-none focus:border-[#1A73E8] focus:ring-1 focus:ring-[#1A73E8] transition-all"
              />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#5F6368] pointer-events-none" />
              <input 
                type="email" 
                name="email"
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#5F6368] pointer-events-none" />
              <input 
                type={showPassword ? "text" : "password"}
                name="password"
                placeholder="••••••••" 
                required
                className="w-full bg-white/60 border border-[#DADCE0]/60 rounded-lg py-3 pl-11 pr-12 text-[#202124] placeholder-[#8b949e]/50 focus:outline-none focus:border-[#1A73E8] focus:ring-1 focus:ring-[#1A73E8] transition-all"
              />
              <button
                type="button"
        ...
        <div className="relative z-10 mt-6">
          ...
          <button 
            ...
            className="w-full mt-4 bg-white text-[#202124] font-bold py-3 rounded-lg hover:bg-gray-100 transition-all flex items-center justify-center gap-2 border border-[#DADCE0]"
          >
